...
## notes
- lights floating around auri, speaking in gibberish like fireflies
- auri unresponsive
    - auri ate blue mushrooms?
- granny stew is done
- purple mushrooms now one drought of mushroom
- huel and dripper buy pond scum for 5 gold
- norman asking for direction from the reverent mother
...
- how many flowers per drought? 1 5ft grid per drought -> it spreads
    - auri has 4 droughts, zaz has 1, koromu has 2
- **traveling back to grung village Angakaar**
...
- dripper pick pockets verana for 18 gold
- auri casts produce flame on plant +norman
    - **20**
    - flower is growing back slowly
- veranas objective: trying to save elven populatoin
    ...
    - center of dread? mission
        - illness believed side effect of dread
...
- npc grung playing drums
    ...
    - the goddess that saved us earlier (verana)
    - tell hijikata we must change the village name to 'aurikar'
...
- zaz placing wet washcloths on overflowing med tent grung
    ...
    - zaz flares flames to warm tent, dark purple is highlighted with gold yellow illuminating room in angelic glow of dawn
        - kaneki comes around corner as zaz is glowing (antithesis of kaneki)
...
- all flowers are destroyed, caring for grung in infirmary
...
- from the sky a woman with flower parasol floats down
    - flower petals floating in wind encompassing a man with a sword by his side next to her
    - to crowd: heathens you have destroyed the all blooms head our warning now we will return in 2 days the all blossom will be seeded and you will obey
    - if you continue to disrupt our seeding then you will be destroyed
    - the all bloom shall take the world the all bloom shall be all it is ordained and it is said it is not for you to question the wisdom if the all bloom
- kith will rage!
...
- alino says to auri that your parents house is north of here? thats where i found you, by the serene lake among the ruin husk of a home
...
- send immediate message to high chapel
    - the all bloom: the end of days, similar to dread like rapture or armageddon
    - return to oneness before the creation of differences
...
- huel and zaz know things burning is not the end, its transition
...
- norm wants to stay and defend Angakaar
    - defeat agents of all bloom
- auri wants to go to cabin
- kaneki wants 'all the wealth of our village" pond scum, lilly pads, flies

...
- kalos rides ursa downstairs following dripper
- dust marks (something moved recently)
- dripper pointing at big gold door
    - no handle/locked
    - used to be magic in the door
        - gold metal
        - hinges fade into wall
...
- large dank ritual room
    - gross water
    - center of water deity - arcane marks, barbaric, rough
...
- dripper still cant unsheathe sword (artifact from upstairs mantle)
    - ancient elvish blade 10,000+ years old
- evidence of massacre to create altar
- dread coming from orb
    - ultimate evil
    - norman speaks of destroying altar
    - earthquake

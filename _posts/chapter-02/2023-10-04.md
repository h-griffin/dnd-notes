...
date: 2023-10-04
page_num: 17
title: "Temple of Shaza El"
---   

## recap
- leveled up (4)
- group traded with then defeated the manticores and continued to the temple
- **group at temple of shaza el mabad**  in desert outside tikrati, taloa
...
- kaneki has his memories of sand sculptor
- auris feet touch dais base and she hears thousands of painful screams
- sauri looks at zaz with disdain
...
- right priest prep room and chasm
    ...
    - verana sees creature rise from ground
        - tentacles attach to her fave
        - verana throws it into chasm
- foot prints down old hallway to the right
    - footsteps shapeless and too big for sauri
...
- huel finds small golden dragon treasure in traps he disables **20**
...
- second room smaller
    ...
    - deep in rock water flows
        ...
        - orchre jelly - gelatin cube, filled with arms and bones

## === COMBAT===
- verana attacks with short swords **20**
...
- auri casts sacred flame
    ...
    - falls asleep "im tired"
    - dripper tries to loot (food)
- auri opens door to golden statues (another)
    - lots of dead small mushrooms
- kaneki recognizes mushroom from tavern fungus lost friend
    - tentacle creature attacks face
    - black staff of shadow smoke
    - blood creeps and makes barrier around him like blood armor

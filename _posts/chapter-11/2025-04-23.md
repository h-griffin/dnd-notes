...
- sleepy little village, hope -full party
    ...
    - travelers offering services, guards and warriors etc
...
- everyone standing in chappel
    ...
    - fiorst high queen maela married to king artorious
- 3 mice bickering
...
- breakthrough in dread books left to be studied in hope
    - tower of ebbonguard protected in pocket dimension created by grimm
    ...
    - except if you travel through the shadows
    - born in shadow shielded by shadow only way to approach in throguh shadow
    - god of shadows realm
    - insanity and death unknown monsters and horros to pass through the shadows
    - ask dripper about the shadows
    - colossal task of traversing the maze would be impossible
    - one reference which lights?
    - they glow and repel shadow from themselves
    - blames norman and kith for allbloom destroying Angakaar
        ...
        - black books have dogeared
            ...
            - secret town witch light, moves in the swamp
- under the erd tree
    - norman scry pool abbot aluvian
        - on carradge on road with lots of people dressed like him, dower look on face
    - arthas scry emberlynn
        - flower crown having fun
    - scry candle jack?
    - koromi look?
    - kith scry rat catcher
    - glitch goes dark
    - not dead
...
- metal box 2ftx1ft 1ft deep in iron locked 3 times hidden by kaneki
    ...
    - norman ok with kaneki owning the town, just wanted the church
...
- 5 pointed blossom green grass abd vines repair the dead afinger artiface
- flower of rev mother is 9 pointed
- all is within my plan

...
prev_title: 44
prev_url: ../chapter-04/2024-04-24 
next_title: 46
next_url: ./2024-05-08 
title: "Requiems Wake"
page_num: 45
...
- verana taken by guards, kith hears in ally way town guards
    - the apostate are on the docks
- in **port artorious** ancorabay

## notes
- kaneki finishes sails, group makes way for the boat
...
- honu parents ship missing
- **lulu tocks** lulu (danger), wants to be captain
    - decklins been missing, my closes friend, i meant to ask him for this shop
    - younger sister to leila danger
- lulu stole some thing from her sister that will make her a better pirate
...
- kanekis dinner has sawdust from us stomping, we have spaghetti instead
...
- kaneki leans back, hears "i feel two of them" i his head, sits back up
    - norman wants to leave for hyaru asap
    - 6 days since weve left, Angakaar is destroyed
- zaz tiger looking cream with purple stripes
- kalv follows auri around because her head is a mushroom
...
- map room, charts of water
    ...
    - endless ocean is called - **T'Avalon**
        - port of t'avalon on kanekis strange map
- kaneki gets to old cobblestone library, two people together in bed
    ...
    - girl nods her head and robe person flips page
        ...
        - creature "**aberration**", kaneki used death magic to escape
    ...
    - some of robe pulls away and sees tumors, recognizes aberration
        - cuts him as it grows back together scarred
    - **jagan** dog wakes up and growls at kaneki
        - jagan disappears into smoke
    - aberration carrying hushs body, sound comes back to area
        - abaration yelling "leave us alone"
        - calv weight increases and large dog tail appears "yesssss mother will love this"
            - +1 pure soul
    - kaneki chases/ teleports after him and attacks, aberration growing
        - punches off mask
...
- xander irl has mystic dragon tea for fire genasi, every storm has a silver lining for koromu
- auri brings norman tea, a gift from one heretic to another
- arrive to beach
    - haunting melody, honu split know song of harpies (sirens)
    - verok nest
- kith and splints see verok nest, not seen yet
...
- splints offers his right arm, torn from socket "more more more fleshy meat!!"
    - are they going to move the cannons? "what in the mothers name are you doing!!???"-norman

...
- cursed bow ornament on a lucky ship
...
- boats are east going north to south we are west going south to north
    ...
    - we are spotted, lead ships bow turns to us
        ...
        - turn around and hope normans wind is fast
        - concoct a crazy plan to continue north fighting or avoiding somehow
    - if were faster we dont have to fight anyone
- kaneki stays below deck, kalv asks for blood sausage with hollandaise
- kith **1** playing with message flags - blue and white stripe
    - kith waves it and flares go off one one of the ships
    - hostages aboard and they need help immediately
- honu stays still they approach behind and slow down to board, then speeding off
    - kith waves to marines as they pass
- normans giggle grass seeds from hyaru - grass seeds that tickle your feet when you walk over
...
- passing Angakaar, once a city now covered in iris blossoms
...
- sending in auri and huel on smaller boat first
    ...
    - splints says trees with clothes could be people with valuables to steal and sell
- norman and kith will wait on the beach
- level up (7) arrived to hyaru
    - inspiring leader skulker lucky spell sniper
    - marchials mage slayer sentinel sheilf master savage attacker
    - spells war caster
    - bards actor
    - mobile observant
...
- auri - frog man and boy smoking storm cigarette
    ...
    - sniper taking out people around the city
        - sees all things that approach, but we have never seen him
- they left a sacrifice and she turned into tree to get into city
...
- all previous enemies here except himiwari
...
- koromu lightning zaps the area auri points to
    - bamboo splits into a million stinkbugs and forms into a person and fires back at koromu
- auri uses faerie fire to make him glow

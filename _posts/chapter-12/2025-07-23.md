...
prev_title: 100
prev_url: ../chapter-11/2025-07-02 
next_title: 102
next_url: ./2025-07-30 
title: "Kpop attack on Hope"
page_num: 101
date: 2025-07-23
---
...
- corridor looking at strange machine
    - tylis ruphe and rupert extracting souls into a ruinous core
    - kind of stopped him, only made a flesh amalgamation from first campaign combat
- stretched in time, some nearly separated
- **in ebbonguard**
...
- strange ethereal wooden ship -party
    - overgrown tree mast
    - thousands of shards and dreamlike fish and stars with floating objects like bridges and rocks
    - unicorn head and clock whales traveling on light
    - central plaza where someone stands
        - party gasps brought back to reality
        - fairly small shimmering, shifts every time you look
    - tree is solid, emanates light where micha touches
    - low gravity area
- party going to jump up hill onto centipede banc and jump down coin
    ...
    - stone dias stitched together like patchwork cloth
...
- **renfren** call me **ren**
    ...
    - i got these for you
        ...
        - arcane technology, giant gun -koromi
    ...
    - holds out piece of swirling magic
        ...
        - we need equilibrium
        - puts something in kuromis hand and
            - the player becomes the story teller
            - during this brief window they act as a temporary DM
    - the sword and wielder will create conflict in 3 days if it does not take his soul
    - aether kin, one of the first ones here
        - then game them light and fire and weirds then aether
        - then they started killing eachother and decided hands off
        - me vedovah and elken
        - continues to be unmet while carter randall is a helpless doof
        - his shift into kato ra el and creation of the dread was foretold
        - unknown who made it happen or who corrupted him
        - betrayed by pura -she shared with talos the flame of valor, flame hot enough to destroy the dread
            - trapped in the plane of infinite prison, sealed him in planes of tartarus across the shadow unable to return
            - him and the rest of the dread army
            - always attempting to return him to power
        - seek out her brother **solaris** with the druids of the erdwell only he knows her location
        - create a star beacon travel to elysium and learn the truth for yourselves
        - norman knows this is where the reverend mother is
            - i know she stays there in my brothers garden i do not know her state
            - the greater protector there was, **rivenell**
        - **nocturne** will kill you if they know you are here
        - not all of them are wrong, one of them is better than the others
            - seek the wolf
                - michas wolf?
...
- hope -party
    - people are locked in combat with insinc put together magical girl group
        - two lances of light that create barriers
        ...
        - giant cannon shoots into crowd but rabbit absorbs it and shoots into the air
            ...
            - eats magical croissant and arm snaps into place, kicks red into the trees
            - come on **marcia**
        - everyone feels woozy
        - kith summons flumf
        - carter randall father coming?
        - jabber rabbit **1** engulfed in normans sphere
            - grabs items with chopsticks eating spere like ramen
        - norman kith arryn smashed by hammer
    - feel darkness coming and colors invert for a moment
        - everyone but micha freezes
            - whos gonna aura farm, micah or kaneki -norman
        - mciha is not effected by magical things
            - girls say oh shit!! and disappear as fast as they can
    - 3 cool members in back and wave cooly with suspicion
        - pink dont say anything to them right now! but they just saved thees people
        - theyll reset everyone theyll forget
        - the star revelry could have gotten too far into this timeline
        - oh shit this ones still going!
            - please dont reset me -micha
        - everone unfrozen -agent puck
            - agent grimm black and pink
            - **star revelry** came to attack you
    - we just attacked tylus
        - youve seen my brohter? weve seen multiple it sounds like
        - **isen**
        - last i heard he was a pawn of my father and in the dreaded school
        ...
        - so hes insane? in this timeline yes
            ...
            - influence of dread
            - **nocturne**? interdimensional police force, preserve the timeline and multiverse
...
- friend silas has made a breakthrough in dragon stone tablet -norman
    - first few notes of dragon song
    - manifest aether itself
    - use magic to make more bright steel?
